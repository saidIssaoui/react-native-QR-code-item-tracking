    ...
    <>
      <ScrollView>
        ...
        <View style={styles.container}>
          <Selector
            textLeft={T.t('categories.form.tools.Brand')}
          ...
          <Margin mb3 />
          <Selector
            textLeft={T.t('categories.form.tools.State')}
          ...
          <Margin mb3 />
          <Selector
            textLeft={T.t('categories.form.tools.Precision')}
          ...
          <Margin mb3 />
          <Rating
            text={T.t('categories.form.tools.Value')}
            rating={rating}
            handleSetRating={handleSetRating}
          />
          <Margin mb3 />
          <Selector
            textLeft={T.t('categories.form.tools.Availability')}
...
export default ToolsFormScreen;
